 ...
 */
final class Version20250705135849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role (id INT NOT NULL, name VARCHAR(60) NOT NULL, access JSON NOT NULL, PRIMARY KEY(id))');
